"""CKV2_CS_AZ_041 - Ensure Azure Container Instance uses managed identity."""
...
class CheckACIManagedIdentity(BaseResourceCheck):
    def __init__(self):
        super().__init__(
            name="Ensure Azure Container Instance uses managed identity",
            id="CKV2_CS_AZ_041",
...
scanner = CheckACIManagedIdentity()
